...
class DiscountPricingStrategyTest {
    ...
    private final DiscountPricingStrategy pricing = new DiscountPricingStrategy();

    @Test
    void emptyBasketCostsZero() {
        BigDecimal price = pricing.priceFor(Basket.of());
    ...
    void oneBookCostsFifty() {
        BigDecimal price = pricing.priceFor(Basket.of(Book.CLEAN_CODE));
    ...
    void twoDifferentBooksGetFivePercentDiscount() {
        ...
        BigDecimal price = pricing.priceFor(basket);
